...
#define EV_ANNOTATION(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION, EvAnnotation))
#define EV_ANNOTATION_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION, EvAnnotationClass))
#define EV_IS_ANNOTATION(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION))
#define EV_IS_ANNOTATION_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION))
#define EV_ANNOTATION_GET_CLASS(object) \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION, EvAnnotationClass))

/* EvAnnotationMarkup */
#define EV_TYPE_ANNOTATION_MARKUP (ev_annotation_markup_get_type())
#define EV_ANNOTATION_MARKUP(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EV_TYPE_ANNOTATION_MARKUP, \
                              EvAnnotationMarkup))
#define EV_ANNOTATION_MARKUP_IFACE(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), EV_TYPE_ANNOTATION_MARKUP, \
                           EvAnnotationMarkupInterface))
#define EV_IS_ANNOTATION_MARKUP(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EV_TYPE_ANNOTATION_MARKUP))
#define EV_IS_ANNOTATION_MARKUP_IFACE(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EV_TYPE_ANNOTATION_MARKUP))
#define EV_ANNOTATION_MARKUP_GET_IFACE(inst)                        \
  (G_TYPE_INSTANCE_GET_INTERFACE((inst), EV_TYPE_ANNOTATION_MARKUP, \
                                 EvAnnotationMarkupInterface))

/* EvAnnotationText */
#define EV_TYPE_ANNOTATION_TEXT (ev_annotation_text_get_type())
#define EV_ANNOTATION_TEXT(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION_TEXT, \
                              EvAnnotationText))
#define EV_ANNOTATION_TEXT_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION_TEXT, \
                           EvAnnotationTextClass))
#define EV_IS_ANNOTATION_TEXT(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION_TEXT))
#define EV_IS_ANNOTATION_TEXT_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION_TEXT))
#define EV_ANNOTATION_TEXT_GET_CLASS(object)                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION_TEXT, \
                             EvAnnotationTextClass))

/* EvAnnotationText */
#define EV_TYPE_ANNOTATION_ATTACHMENT (ev_annotation_attachment_get_type())
#define EV_ANNOTATION_ATTACHMENT(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_ANNOTATION_ATTACHMENT, \
                              EvAnnotationAttachment))
#define EV_ANNOTATION_ATTACHMENT_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_ANNOTATION_ATTACHMENT, \
                           EvAnnotationAttachmentClass))
#define EV_IS_ANNOTATION_ATTACHMENT(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_ANNOTATION_ATTACHMENT))
#define EV_IS_ANNOTATION_ATTACHMENT_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_ANNOTATION_ATTACHMENT))
#define EV_ANNOTATION_ATTACHMENT_GET_CLASS(object)                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_ANNOTATION_ATTACHMENT, \
                             EvAnnotationAttachmentClass))
