...
#define EV_DOCUMENT_ANNOTATIONS(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EV_TYPE_DOCUMENT_ANNOTATIONS, \
                              EvDocumentAnnotations))
#define EV_DOCUMENT_ANNOTATIONS_IFACE(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), EV_TYPE_DOCUMENT_ANNOTATIONS, \
                           EvDocumentAnnotationsInterface))
#define EV_IS_DOCUMENT_ANNOTATIONS(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EV_TYPE_DOCUMENT_ANNOTATIONS))
#define EV_IS_DOCUMENT_ANNOTATIONS_IFACE(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EV_TYPE_DOCUMENT_ANNOTATIONS))
#define EV_DOCUMENT_ANNOTATIONS_GET_IFACE(inst)                        \
  (G_TYPE_INSTANCE_GET_INTERFACE((inst), EV_TYPE_DOCUMENT_ANNOTATIONS, \
                                 EvDocumentAnnotationsInterface))
...
struct _EvDocumentAnnotationsInterface {
  ...
  void (*add_annotation)(EvDocumentAnnotations *document_annots,
                         EvAnnotation *annot, EvRectangle *rect);
  void (*save_annotation)(EvDocumentAnnotations *document_annots,
                          EvAnnotation *annot, EvAnnotationsSaveMask mask);
