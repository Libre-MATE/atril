...
static void ev_form_field_signature_init(
    EvFormFieldSignature *field_signature) {}

static void ev_form_field_signature_class_init(
    EvFormFieldSignatureClass *klass) {}
...
EvFormField *ev_form_field_text_new(gint id, EvFormFieldTextType type) {
  ...
  g_return_val_if_fail(type >= EV_FORM_FIELD_TEXT_NORMAL &&
                           type <= EV_FORM_FIELD_TEXT_FILE_SELECT,
                       NULL);
...
EvFormField *ev_form_field_button_new(gint id, EvFormFieldButtonType type) {
  ...
  g_return_val_if_fail(
      type >= EV_FORM_FIELD_BUTTON_PUSH && type <= EV_FORM_FIELD_BUTTON_RADIO,
      NULL);
...
EvFormField *ev_form_field_choice_new(gint id, EvFormFieldChoiceType type) {
  ...
  g_return_val_if_fail(id >= 0, NULL);
  g_return_val_if_fail(
      type >= EV_FORM_FIELD_CHOICE_COMBO && type <= EV_FORM_FIELD_CHOICE_LIST,
      NULL);
