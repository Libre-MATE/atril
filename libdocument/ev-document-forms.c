...
static void ev_document_forms_default_init(EvDocumentFormsInterface *klass) {}
...
gboolean ev_document_forms_document_is_modified(
  ...
  return (iface->document_is_modified)
             ? iface->document_is_modified(document_forms)
             : FALSE;
}
...
gboolean ev_document_forms_form_field_choice_is_item_selected(
  ...
  return iface->form_field_choice_is_item_selected(document_forms, field,
                                                   index);
}
