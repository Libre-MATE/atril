...
#define EV_PREVIEWER_WINDOW(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_PREVIEWER_WINDOW, \
                              EvPreviewerWindow))
#define EV_PREVIEWER_WINDOW_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_PREVIEWER_WINDOW, \
                           EvPreviewerWindowClass))
#define EV_IS_PREVIEWER_WINDOW(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_PREVIEWER_WINDOW))
#define EV_IS_PREVIEWER_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_PREVIEWER_WINDOW))
#define EV_PREVIEWER_WINDOW_GET_CLASS(object)                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_PREVIEWER_WINDOW, \
                             EvPreviewerWindowClass))
