...
#define EV_PAGE_ACTION_WIDGET(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_PAGE_ACTION_WIDGET, \
                              EvPageActionWidget))
...
struct _EvPageActionWidgetClass {
  ...
  void (*activate_link)(EvPageActionWidget *page_action, EvLink *link);
};
