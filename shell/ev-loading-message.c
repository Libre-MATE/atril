...
static void ev_loading_message_size_allocate(GtkWidget *widget,
  ...
  GTK_WIDGET_CLASS(ev_loading_message_parent_class)
...
static void ev_loading_message_class_init(EvLoadingMessageClass *klass) {
  ...
  gtk_widget_class->get_preferred_width =
      ev_loading_message_get_preferred_width;
  gtk_widget_class->get_preferred_height =
      ev_loading_message_get_preferred_height;
...
GtkWidget *ev_loading_message_new(void) {
  ...
  message = g_object_new(EV_TYPE_LOADING_MESSAGE, "orientation",
