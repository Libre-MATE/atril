...
#define EV_HISTORY(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_HISTORY, EvHistory))
#define EV_HISTORY_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_HISTORY, EvHistoryClass))
#define EV_IS_HISTORY(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_HISTORY))
#define EV_IS_HISTORY_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((obj), EV_TYPE_HISTORY))
#define EV_HISTORY_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EV_TYPE_HISTORY, EvHistoryClass))
