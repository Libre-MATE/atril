...
#define EV_PASSWORD_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_PASSWORD_VIEW, EvPasswordView))
#define EV_IS_PASSWORD_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_PASSWORD_VIEW))
