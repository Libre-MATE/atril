...
#define EV_BOOKMARK_ACTION(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_BOOKMARK_ACTION, \
                              EvBookmarkAction))
#define EV_BOOKMARK_ACTION_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_BOOKMARK_ACTION, \
                           EvBookmarkActionClass))
#define EV_IS_BOOKMARK_ACTION(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_BOOKMARK_ACTION))
