...
#define EV_BOOKMARKS(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_BOOKMARKS, EvBookmarks))
#define EV_BOOKMARKS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_BOOKMARKS, EvBookmarksClass))
#define EV_IS_BOOKMARKS(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_BOOKMARKS))
