...
const gchar *ev_sidebar_page_get_label(EvSidebarPage *sidebar_page) {
  EvSidebarPageInterface *iface;
...
static void ev_sidebar_page_default_init(EvSidebarPageInterface *iface) {
  static gboolean initialized = FALSE;

  if (!initialized) {
    g_object_interface_install_property(
        iface, g_param_spec_object("main-widget", "Main Widget",
