...
#define EV_PROGRESS_MESSAGE_AREA(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_PROGRESS_MESSAGE_AREA, \
                              EvProgressMessageArea))
#define EV_PROGRESS_MESSAGE_AREA_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_PROGRESS_MESSAGE_AREA, \
                           EvProgressMessageAreaClass))
#define EV_IS_PROGRESS_MESSAGE_AREA(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_PROGRESS_MESSAGE_AREA))
#define EV_IS_PROGRESS_MESSAGE_AREA_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_PROGRESS_MESSAGE_AREA))
#define EV_PROGRESS_MESSAGE_AREA_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EV_TYPE_PROGRESS_MESSAGE_AREA, \
                             EvProgressMessageAreaClass))
