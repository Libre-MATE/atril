...
#define EV_PROPERTIES_LICENSE(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_PROPERTIES_LICENSE, \
                              EvPropertiesLicense))
#define EV_PROPERTIES_LICENSE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_PROPERTIES_LICENSE, \
                           EvPropertiesLicenseClass))
#define EV_IS_PROPERTIES_LICENSE(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_PROPERTIES_LICENSE))
#define EV_IS_PROPERTIES_LICENSE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_PROPERTIES_LICENSE))
#define EV_PROPERTIES_LICENSE_GET_CLASS(object)                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_PROPERTIES_LICENSE, \
                             EvPropertiesLicenseClass))
