...
#define EV_PROPERTIES_DIALOG(object)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), EV_TYPE_PROPERTIES_DIALOG, \
                              EvPropertiesDialog))
#define EV_PROPERTIES_DIALOG_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EV_TYPE_PROPERTIES_DIALOG, \
                           EvPropertiesDialogClass))
#define EV_IS_PROPERTIES_DIALOG(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), EV_TYPE_PROPERTIES_DIALOG))
#define EV_IS_PROPERTIES_DIALOG_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EV_TYPE_PROPERTIES_DIALOG))
#define EV_PROPERTIES_DIALOG_GET_CLASS(object)                    \
  (G_TYPE_INSTANCE_GET_CLASS((object), EV_TYPE_PROPERTIES_DIALOG, \
                             EvPropertiesDialogClass))
