...
#define EV_DOCUMENT_MODEL(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_DOCUMENT_MODEL, EvDocumentModel))
#define EV_IS_DOCUMENT_MODEL(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_DOCUMENT_MODEL))
