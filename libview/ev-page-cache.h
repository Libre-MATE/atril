...
#define EV_PAGE_CACHE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_PAGE_CACHE, EvPageCache))
#define EV_IS_PAGE_CACHE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_PAGE_CACHE))
