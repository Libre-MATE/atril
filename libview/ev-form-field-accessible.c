...
static void ev_form_field_accessible_component_iface_init(
    AtkComponentIface *iface);

G_DEFINE_TYPE_WITH_CODE(
    EvFormFieldAccessible, ev_form_field_accessible, ATK_TYPE_OBJECT,
    G_ADD_PRIVATE(EvFormFieldAccessible)
        G_IMPLEMENT_INTERFACE(ATK_TYPE_COMPONENT,
                              ev_form_field_accessible_component_iface_init))

static void ev_form_field_accessible_get_extents(AtkComponent *atk_component,
...
static gboolean ev_form_field_accessible_grab_focus(
...
static AtkObject *ev_form_field_accessible_get_parent(AtkObject *atk_object) {
  EvFormFieldAccessiblePrivate *priv =
      EV_FORM_FIELD_ACCESSIBLE(atk_object)->priv;

  return ATK_OBJECT(priv->page);
}

static AtkRole ev_form_field_accessible_get_role(AtkObject *atk_object) {
...
static AtkStateSet *ev_form_field_accessible_ref_state_set(
  ...
  state_set = ATK_OBJECT_CLASS(ev_form_field_accessible_parent_class)
...
static void ev_form_field_accessible_finalize(GObject *object) {
...
static void ev_form_field_accessible_class_init(
    EvFormFieldAccessibleClass *klass) {
