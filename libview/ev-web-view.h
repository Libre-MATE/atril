...
#define EV_WEB_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EV_TYPE_WEB_VIEW, EvWebView))
#define EV_IS_WEB_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EV_TYPE_WEB_VIEW))
...
void ev_web_view_find_set_highlight_search(EvWebView *webview,
                                           gboolean visible);
