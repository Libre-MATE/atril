...
#define EGG_TOOLBARS_MODEL(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EGG_TYPE_TOOLBARS_MODEL, EggToolbarsModel))
#define EGG_TOOLBARS_MODEL_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EGG_TYPE_TOOLBARS_MODEL, \
                           EggToolbarsModelClass))
#define EGG_IS_TOOLBARS_MODEL(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EGG_TYPE_TOOLBARS_MODEL))
#define EGG_IS_TOOLBARS_MODEL_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EGG_TYPE_TOOLBARS_MODEL))
#define EGG_TOOLBARS_MODEL_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EGG_TYPE_TOOLBARS_MODEL, \
                             EggToolbarsModelClass))
...
struct EggToolbarsModelClass {
  ...
  /* Signals */
  void (*item_added)(EggToolbarsModel *model, int toolbar_position,
                     int position);
  void (*item_removed)(EggToolbarsModel *model, int toolbar_position,
                       int position);
  ...
  /* Virtual Table */
  gboolean (*add_item)(EggToolbarsModel *t, int toolbar_position, int position,
                       const char *name);
};
...
/* Functions for manipulating the types of portable data this toolbar
 * understands. */
