...
#define DVI_DOCUMENT(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), DVI_TYPE_DOCUMENT, DviDocument))
#define DVI_IS_DOCUMENT(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), DVI_TYPE_DOCUMENT))
